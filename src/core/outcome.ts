...
const rules: OutcomeRule[] = [
  {
    ...
    label: { ja: '賢明な導き手', en: 'Wise Guide' },
    detail: {
      ja: '知恵と道徳心で周囲を支えた人生。',
      en: 'You steered others with wit and kindness.'
    }
  },
  {
    condition: (stats) => stats.wealth > 95 && stats.happiness > 70,
    label: { ja: '豊潤な開拓者', en: 'Prosperous Trailblazer' },
    detail: {
      ja: '資産を築きながら楽しみを見いだした。',
      en: 'Built wealth while keeping joy in sight.'
    }
  },
  {
    condition: (stats) => stats.health > 85 && stats.happiness > 85,
    label: { ja: '健やかな探求者', en: 'Vibrant Explorer' },
    detail: {
      ja: '心身ともに充実した日々を送った。',
      en: 'Balanced body and mind through the journey.'
    }
  },
  {
    condition: (stats) => stats.intelligence > 90,
    label: { ja: '知識の架け橋', en: 'Bridge of Knowledge' },
    detail: {
      ja: '学びを積み重ね、次代に伝えた。',
      en: 'You collected and shared knowledge generously.'
    }
  },
  {
    condition: (stats) => stats.morality < 25 || stats.happiness < 25,
    label: { ja: '岐路に立つ旅人', en: 'Wanderer at the Crossroads' },
    detail: {
      ja: '迷いもあったが、まだ巻き返せる。',
      en: 'Struggled at times, but the story isn’t over.'
    }
  }
]
...
const fallback: OutcomeRule = {
  condition: () => true,
  label: { ja: '静かな日常', en: 'Quiet Days' },
  detail: {
    ja: '揺らぎながらも自分らしい歩みを続けた。',
    en: 'You kept moving in your own rhythm.'
  }
}
